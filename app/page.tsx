...
export default function Home() {
  ...
  return (
    ...
    <div className="h-screen w-screen  flex  items-center justify-center">
      <div className="w-4/6 h-4/5 flex  flex-col-reverse md:flex-row-reverse  ">
        ...
        <input placeholder="johm@example.com" type="email" name="email" id="email" className="p-2 focus:outline-none border-2 border-background rounded-md focus:border-2 focus:border-bblue  w-full" />
            </div>
        <div className="flex flex-col gap-y-2">
        <label htmlFor="" className="text-xl ">Password</label>
              
        <input placeholder="at least 8 charcters " type="password" name="password" id="password" className="p-2 focus:outline-none border-2 border-background rounded-md focus:border-2 focus:border-bblue w-full" />
            </div>
